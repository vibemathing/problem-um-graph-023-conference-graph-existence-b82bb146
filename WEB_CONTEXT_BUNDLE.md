...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-graph-023-conference-graph-existence-b82bb146-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GRAPH-023"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-graph-023-conference-graph-existence-b82bb146-v1",
      "problem_contract_sha256": "3a5afe62199f32b9492a61fbd395965939b4a3c94d20df1c71d797743beb3e49",
      "problem_id": "problem:um-graph-023-conference-graph-existence-b82bb146",
      "route_id": "route:um-graph-023-conference-graph-existence-b82bb146-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-graph-023-conference-graph-existence-b82bb146-source-fidelity-01",
      "graph_id": "graph:um-graph-023-conference-graph-existence-b82bb146-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-graph-023-conference-graph-existence-b82bb146-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-graph-023-conference-graph-existence-b82bb146-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does there exist a conference graph for every number of vertices $v > 1$ where $v \\equiv 1 \\pmod{4}$ and v is an odd sum of two squares?"
          },
          "statement_sha256": "dc0e3a09df10745feb8778b45d41e1aee042c0c78841b82460cf9bb39c271424"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-graph-023-conference-graph-existence-b82bb146-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-graph-023-conference-graph-existence-b82bb146-root",
      "route_id": "route:um-graph-023-conference-graph-existence-b82bb146-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-graph-023-2a328dc32ed2",
        "url": "https://www.unsolvedmath.com/problems/GRAPH-023"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
